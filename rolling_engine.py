"""
PropEdge V11.0 — Rolling Stats Engine
======================================
...
def extract_prediction_features(prior_played, line):
    ...
    fg3a10 = safe_mean(p, 'FG3A', 10)
    def fg3_pct_safe(n):
        v = safe_mean(p, 'FG3_PCT', n)
        if v is None: return None
        return round(v * 100, 1) if v < 1.5 else round(v, 1)
    fg3_pct10 = fg3_pct_safe(10)
    ...
    return {
        ...
        'fg3a10': round(fg3a10, 1) if fg3a10 is not None else 0.0,
        'fg3_pct10': fg3_pct10 or 0.0,
